...
export function Model(props) {
  const { nodes, materials } = useGLTF('/sci/sceneDraco-transformed.glb')
  return (
    <group {...props} dispose={null}>
      <group scale={0.01}>
        <group position={[0, 28.87, 312.19]} rotation={[-1.47, 0, 0]} scale={100}>
        ...
        <group position={[0, 381.81, -82.66]} rotation={[-0.23, 0, 0]} scale={100}>
        ...
        <group position={[0, 0, -94.76]} rotation={[0, Math.PI / 2, 0]} scale={123.8}>
